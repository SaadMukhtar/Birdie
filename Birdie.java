...
public class Birdie extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, ActionListener
{
    ...
    {
	if (score < 10) g.drawImage (Background, 0, 0, this);
	else if (score <= 20) g.drawImage (NightBackground, 0, 0, this);
	else if (score <= 30) g.drawImage(CyanBackground, 0, 0, this);
	else if (score <= 40) g.drawImage (Background, 0, 0, this);
	else if (score <= 50) g.drawImage (NightBackground, 0, 0, this);
	else if (score <= 60) g.drawImage(CyanBackground, 0, 0, this);
